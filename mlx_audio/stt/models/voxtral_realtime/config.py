...
class TextConfig:
    ...
    def rope_theta(self) -> float:
        return float(self.data.get("rope_theta", 1000000.0))
...
class AudioConfig:
    ...
    def downsample_factor(self) -> int:
        return int(self.data.get("downsample_factor", 4))
...
def _normalize_split_audio_config(audio_cfg: Dict[str, Any]) -> Dict[str, Any]:
    ...
    normalized = {
        ...
        "downsample_factor": _first_not_none(remapped.get("downsample_factor"), 4),
...
def _remap_mistral_audio_args(cfg: Dict[str, Any]) -> Tuple[Dict[str, Any], Dict[str, Any]]:
    ...
    downsample_factor = _first_not_none(downsample_args.get("downsample_factor"), 4)
