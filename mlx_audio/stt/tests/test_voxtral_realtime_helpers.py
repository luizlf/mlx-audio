...
def test_stream_transcribe_realtime_stays_realtime_before_fallback(
    ...
    monkeypatch.setattr(voxtral_api, "_get_streaming_mode", lambda _name: object())
    ...
    runtime.tokenizer = type(
        ...
        (),
        {
            "decode": staticmethod(lambda *_args, **_kwargs: ""),
...
def test_voxtral_config_from_multimodal_dict() -> None:
    ...
    vox = VoxtralRealtimeConfig.from_dict(cfg)
    assert vox.audio.num_mel_bins == 80
    assert vox.audio.sliding_window == 1000
